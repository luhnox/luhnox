  ...
  const projects: Project[] = [
    {
      ...
      description:
        'A modern, responsive portfolio website built with React, TypeScript, and Tailwind CSS. Features smooth animations, particle effects, and a sleek dark theme.',
    ...
    },
    {
      ...
      description:
        'Scalable API gateway built with Node.js featuring rate limiting, authentication, and request routing capabilities.',
      image: '/project-thumbnail.jpg',
